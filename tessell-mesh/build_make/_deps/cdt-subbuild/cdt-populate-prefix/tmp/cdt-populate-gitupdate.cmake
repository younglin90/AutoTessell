...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "1.4.4"
  WORKING_DIRECTORY "/home/younglin90/work/claude_code/AutoTessell/tessell-mesh/build_make/_deps/cdt-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.4.4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/1.4.4")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"1.4.4\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/younglin90/work/claude_code/AutoTessell/tessell-mesh/build_make/_deps/cdt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/younglin90/work/claude_code/AutoTessell/tessell-mesh/build_make/_deps/cdt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
