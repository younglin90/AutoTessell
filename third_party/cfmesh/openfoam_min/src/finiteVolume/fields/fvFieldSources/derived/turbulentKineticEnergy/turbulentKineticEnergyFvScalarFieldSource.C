...
#include "turbulentKineticEnergyFvScalarFieldSource.H"
#include "fvSource.H"
#include "volFields.H"
...
Foam::turbulentKineticEnergyFvScalarFieldSource::
...
turbulentKineticEnergyFvScalarFieldSource
(
    const turbulentKineticEnergyFvScalarFieldSource& field,
    const DimensionedField<scalar, fvMesh>& iF
)
:
...
Foam::turbulentKineticEnergyFvScalarFieldSource::sourceValue
(
...
Foam::tmp<Foam::DimensionedField<Foam::scalar, Foam::fvMesh>>
Foam::turbulentKineticEnergyFvScalarFieldSource::internalCoeff
(
    const fvSource& model,
    const DimensionedField<scalar, fvMesh>& source
) const
...
void Foam::turbulentKineticEnergyFvScalarFieldSource::write
(
    Ostream& os
) const
{
