...
def test_qed_decimate_auto_triggers_on_large_input() -> None:
    ...
    beta2308 은 default "auto" → F.shape[0] > MIN_F 시 자동 ON.
    beta2364: MIN_F default 50000 → 20000 (Hu 2018 §3.4 적극).
    ...
    # beta2364: 20000 임계 (이전 50000).
    assert '"AUTO_TESSELL_QED_MIN_F", "20000"' in src, \
        "QED_MIN_F default 20000 누락 (beta2364)"
    # auto 분기 자동 활성 로직.
